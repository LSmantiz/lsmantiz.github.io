...
::: {.g-col-12 .g-col-md-6 .gallery-card}
[![](posts/econ-interactive-tool/overview.png)](posts/econ-interactive-tool/index.qmd)

[**Interactive teaching tool: Efficiency wages, markets & tax incidence**<br>
A self-contained interactive economics visualization (vanilla JS + canvas), built with generative AI for introductory economics teaching — explore the model with sliders, no installation needed.](posts/econ-interactive-tool/index.qmd){.gallery-caption}
:::
